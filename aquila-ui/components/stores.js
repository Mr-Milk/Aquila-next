...
export const dataPageStore = create(set => ({
    ...
    setRecordData: (data) => set(state => {state.recordData = data;}),
    setRoiMeta: (data) => set(state => {state.roiMeta = data;}),
    setCellData: (data) => set(state => {state.cellData = data;}),
    setBBox: (data) => set(state => {state.bbox = data;}),
    setBBox3d: (data) => set(state => {state.bbox3d = data;}),
    setDataType: (data) => set(state => {state.is3d = data;}),
